...
namespace AUEUMS.Custom
{
    public class CustomSecurity
    {
        ...
        {
            //dotnet user-secrets set "Authentication:DataCore:Password" "<Password>"
            //asemeco@2020byITSolutionDelivery
            //dotnet user-secrets set "Authentication:DataCore:SecureKey" "<SecureKey>"
            //sdasda123123123123asdasd123123123asdad1312312312v123v3v123a3&T&8dfdfdsfdsf
